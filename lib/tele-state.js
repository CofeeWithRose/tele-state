...
var TeleState = /** @class */ (function () {
    ...
    TeleState.prototype.handleUpdate = function (pre, newS) {
        return __awaiter(this, void 0, void 0, function () {
            var list, i, _a, curState, setState;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.handlePlugin(pre, newS);
                        list = Object.values(this.setStateMap);
                        i = 0;
                        _b.label = 1;
                    case 1:
                        if (!(i < list.length)) return [3 /*break*/, 4];
                        _a = list[i], curState = _a[0], setState = _a[1];
                        // console.log('Component handleUpdate---', newS, curState)
                        // console.log('Component update--0', newS, i)
                        if (curState !== newS)
                            setState(newS);
